...
def get_relation(relation_key1, relation_key2):
    ...
    'north northEast': 'west', 'north northWest': 'east', 'north southEast': 'north', 'north southWest': 'north',

    'south north':'south', 'south west': 'south-east', 'south east': 'south-west', 'south middle': 'south',
    'south southEast': 'west', 'south southWest': 'east', 'south northEast': 'south', 'south northWest': 'south',

    'east west': 'east', 'east north': 'south-east', 'east south': 'north-east', 'east middle': 'east',
    'east northEast': 'south', 'east southEast': 'north', 'east northWest': 'east', 'east southWest': 'east',

    'west east': 'west', 'west north': 'south-west', 'west south': 'north-west', 'west middle': 'west',
    'west northWest': 'south', 'west southWest': 'north', 'west northEast': 'west', 'west southEast': 'west',

    'northEast southWest': 'north-east', 'northEast northWest': 'east', 'northEast southEast': 'north',
    'northEast middle': 'north-east', 'northEast north': 'east', 'northEast east': 'north', 'northEast west': 'east', 'northEast south': 'north',

    'northWest southWest': 'north', 'northWest northEast': 'west', 'northWest southEast': 'north-west',
    'northWest middle': 'north-west', 'northWest north': 'west', 'northWest west':'north', 'northWest east': 'west', 'northWest south': 'north',
    
    'southWest northWest': 'south', 'southWest northEast': 'south-west', 'southWest southEast': 'west',
    'southWest middle': 'south-west', 'southWest south': 'west', 'southWest west': 'south', 'southWest north': 'south', 'southWest east': 'west',

    'southEast northWest': 'south-east', 'southEast northEast': 'south', 'southEast southWest': 'east',
    'southEast middle': 'south-east', 'southEast south': 'east', 'southEast east': 'south', 'southEast north': 'south', 'southEast west': 'east',
...
'''
Prefers perfect triangles as well as main cardinal directions
'''
