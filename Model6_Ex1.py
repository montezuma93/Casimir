...
def get_relation(relation_key1, relation_key2):
    ...
    'north northEast': 'north-west', 'north northWest': 'north-east', 'north southEast': 'north', 'north southWest': 'north',

    'south north':'south', 'south west': 'south-east', 'south east': 'south-west', 'south middle': 'south',
    'south southEast': 'south-west', 'south southWest': 'south-east', 'south northEast': 'south', 'south northWest': 'south',

    'east west': 'east', 'east north': 'south-east', 'east south': 'north-east', 'east middle': 'east',
    'east northEast': 'south-east', 'east southEast': 'north-east', 'east northWest': 'east', 'east southWest': 'east',

    'west east': 'west', 'west north': 'south-west', 'west south': 'north-west', 'west middle': 'west',
    'west northWest': 'south-west', 'west southWest': 'north-west', 'west northEast': 'west', 'west southEast': 'west',

    'northEast southWest': 'north-east', 'northEast northWest': 'east', 'northEast southEast': 'north',
    'northEast middle': 'north-east', 'northEast north': 'south-east', 'northEast east': 'north-west', 'northEast west': 'east', 'northEast south': 'north',

    'northWest southWest': 'north', 'northWest northEast': 'west', 'northWest southEast': 'north-west',
    'northWest middle': 'north-west', 'northWest north': 'south-west', 'northWest west':'north-east', 'northWest east': 'west', 'northWest south': 'north',
    
    'southWest northWest': 'south', 'southWest northEast': 'south-west', 'southWest southEast': 'west',
    'southWest middle': 'south-west', 'southWest south': 'north-west', 'southWest west': 'south-east', 'southWest north': 'south', 'southWest east': 'west',

    'southEast northWest': 'south-east', 'southEast northEast': 'south', 'southEast southWest': 'east',
    'southEast middle': 'south-east', 'southEast south': 'north-east', 'southEast east': 'south-west', 'southEast north': 'south', 'southEast west': 'east',
...
'''
Prefers sharp triangle (will place object close to the middle) as well as main cardinal directions
'''
class Model6(ccobra.CCobraModel):

    def __init__(self, name='Model6'):
        super(Model6, self).__init__(name, ['relational'], ['verify', 'single_choice'])
